 ...
 */
FOUNDATION_EXPORT const CGFloat kJSQMessagesCollectionViewCellNicknameLabelHeightDefault;
...
/** 时间区右侧预留宽度（如收藏夹 yy/M/d HH:mm 需更大）。0 表示使用默认 56pt，设为 90 等可预留更长时间串 */
@property (assign, nonatomic) CGFloat messageBubbleTimeAreaRightInset;
