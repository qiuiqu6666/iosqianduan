...
- (void)configCustomNaviBar {
    ...
    // 给按钮设置液态玻璃效果
    [BasicTool setClearGlassBgnConfig:_backButton];
    ...
    // 给按钮设置液态玻璃效果
    [BasicTool setClearGlassBgnConfig:_selectButton];
...
- (void)configBottomToolBar {
    ...
    // 针对ios 26的优化：按钮设置了液态玻璃效果后就不要这个背景了，不然不好看 - add by jackjiang 20250922
    if (@available(iOS 26, *)) {
    } else {
    ...
    _doneButton.titleLabel.font = [UIFont boldSystemFontOfSize:17];// 250903 js 修改为粗体和17号
    ...
    // 给按钮设置液态玻璃效果
    [BasicTool setClearGlassBgnConfig:_doneButton];
...
- (void)viewDidLayoutSubviews {
    ...
    if (isRTL) {
        // 针对ios 26的优化：给按钮设置液态玻璃效果 - add by jackjiang 20250922
        if (@available(iOS 26, *)) {
            _backButton.frame = CGRectMake(self.view.tz_width - 64, 10 + statusBarHeightInterval, 44, 44);
            _backButton.layer.transform = CATransform3DMakeRotation(M_PI, 0, 1, 0);
            _selectButton.frame = CGRectMake(22, 10 + statusBarHeightInterval, 44, 44);
        }
        else
        {
        ...
        // 针对ios 26的优化：给按钮设置液态玻璃效果 - add by jackjiang 20250922
        if (@available(iOS 26, *)) {
            _backButton.frame = CGRectMake(20, 10 + statusBarHeightInterval, 44, 44);
            _selectButton.frame = CGRectMake(self.view.tz_width - 66, 10 + statusBarHeightInterval, 44, 44);
        }
        else
        {
...
//      _doneButton.frame = CGRectMake(self.view.tz_width - _doneButton.tz_width - 12, 0, MAX(44, _doneButton.tz_width), 44);
        _doneButton.frame = CGRectMake(self.view.tz_width - _doneButton.tz_width - 30, 0, MAX(44, _doneButton.tz_width), 44);// 250903 js 修改过
