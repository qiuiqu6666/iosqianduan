...
static const CGFloat XYMenuWidth = 140;//120; // Menu宽度
...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        self.backgroundColor = [UIColor colorWithRed:0.0f/255.0f green:0.0f/255.0f blue:0.0f/255.0f alpha:0.3f];//[UIColor clearColor];
