...
static const CGFloat MBDefaultLabelFontSize = 15.f;// Jack Jiang 于v7.0 将原“16.f”改为了现值
...
- (void)setupViews {
    ...
    // Jack Jiang 于v7.0 将原“5.f”改为了现值
    // Jack Jiang 于v10.2 将原“12.f”改为了现值
    // Jack Jiang 于v10.2 将原“16.f”改为了现值
    bezelView.layer.cornerRadius = 20.0f;
    bezelView.alpha = 0.f;
...
//    label.font = [UIFont boldSystemFontOfSize:MBDefaultLabelFontSize];
    label.font = [UIFont systemFontOfSize:MBDefaultLabelFontSize]; // 由Jack Jiang于v7.0由原粗体改为了普体
    label.opaque = NO;
...
//    detailsLabel.font = [UIFont boldSystemFontOfSize:MBDefaultDetailsLabelFontSize];
    detailsLabel.font = [UIFont systemFontOfSize:MBDefaultDetailsLabelFontSize]; // 由Jack Jiang于v7.0由原粗体改为了普体
...
//    button.titleLabel.font = [UIFont boldSystemFontOfSize:MBDefaultDetailsLabelFontSize]; // 由Jack Jiang于v7.0由原粗体改为了普体
    button.titleLabel.font = [UIFont systemFontOfSize:MBDefaultDetailsLabelFontSize];
