...
+ (LBXScanViewStyle*)ZhiFuBaoStyle
{
    ...
    style.xScanRetangleOffset = 0;//30;
    
    if ([UIScreen mainScreen].bounds.size.height <= 480 )
    {
        //3.5inch 显示的扫码缩小
        style.centerUpOffset = 40;
        style.xScanRetangleOffset = 0;//20;
    }
    ...
    style.colorAngle = [UIColor colorWithRed:0 green:0 blue:0 alpha:0];
    
    style.isNeedShowRetangle = NO;
    style.anmiationStyle = LBXScanViewAnimationStyle_NetGrid;
    
    style.notRecoginitonArea = [UIColor colorWithRed:0 green:0 blue:0 alpha:0];//[UIColor colorWithRed:0 green:0 blue:0 alpha:0.6];
...
#pragma mark - RainbowChat 扫一扫（镂空 + 四角边框）
+ (LBXScanViewStyle *)rainbowChatScanStyle
{
    LBXScanViewStyle *style = [[LBXScanViewStyle alloc] init];
    style.centerUpOffset = 60;
    style.xScanRetangleOffset = 52;
    if ([UIScreen mainScreen].bounds.size.height <= 568) {
        style.centerUpOffset = 44;
        style.xScanRetangleOffset = 36;
    }
    style.whRatio = 1.0;
    style.isNeedShowRetangle = YES;
    style.colorRetangleLine = [[UIColor whiteColor] colorWithAlphaComponent:0.45];
    style.photoframeAngleStyle = LBXScanViewPhotoframeAngleStyle_Outer;
    style.photoframeLineW = 4.0;
    style.photoframeAngleW = 30;
    style.photoframeAngleH = 30;
    style.colorAngle = [UIColor colorWithRed:0.f green:200.f / 255.f blue:90.f / 255.f alpha:1.0];
    style.anmiationStyle = LBXScanViewAnimationStyle_LineMove;
    style.animationImage = [UIImage imageNamed:@"CodeScan.bundle/qrcode_scan_light_green"];
    style.notRecoginitonArea = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.58];
    return style;
}
